...
public class UploadImage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageCategory = findViewById(R.id.category_division);
        ...
        String[] items = new String[]{"Select Any One", "Convocation", "Gathering", "Independence Day", "Republic Day", "Others Events"};
