...
public class UploadStudyMaterialActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        uploadpdfBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(UploadStudyMaterialActivity.this, "Please Upload PDF", Toast.LENGTH_SHORT).show();
                }
                else if (category1.equals("Select standard"))
                {
                    Toast.makeText(UploadStudyMaterialActivity.this, "Please select Standard", Toast.LENGTH_SHORT).show();
                }
    ...
    private void uploadpdf()
    {
        ...
        reference.child(category1).child(category2).child(category3).putFile(pdfdata).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onFailure(@NonNull @NotNull Exception e) {
                Toast.makeText(UploadStudyMaterialActivity.this,"Something went wrong",Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void uploadData(String valueOf)
    {
        ...
        databaseReference.child("Study Material").child(category1).child(category2).child(category3).child(uniqueKey).setValue(data).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            {
                pd.dismiss();
                Toast.makeText(UploadStudyMaterialActivity.this,"File uploaded successfully",Toast.LENGTH_SHORT).show();
                pdfTitle.setText("");
            ...
            public void onFailure(@NonNull @NotNull Exception e) {
                pd.dismiss();
               Toast.makeText(UploadStudyMaterialActivity.this,"Failed to upload pdf",Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == REQ && resultCode == RESULT_OK){
           ...
           if(pdfdata.toString().startsWith("content://"))
           {
               Cursor cursor = null;
               try {
                   cursor = UploadStudyMaterialActivity.this.getContentResolver().query(pdfdata,null,null,null,null);
